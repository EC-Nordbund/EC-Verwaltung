  ...
  v-list(two-line)
    ...
    v-list-tile
      v-list-tile-action
        v-icon person
      v-list-tile-content
        v-list-tile-title {{ data.radfahren ? "Rad fahren, " : "" }} {{ data.klettern ? "Klettern, " : "" }} {{ data.bootfahren ? "Boot fahren, " : "" }} {{ data.schwimmen > 0 ? "Schwimmen, " : "" }} {{ data.fahrgemeinschaften ? "Fahrgemeinschaften" : "" }}
